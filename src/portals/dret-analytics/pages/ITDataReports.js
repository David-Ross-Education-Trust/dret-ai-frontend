...
import { visibleReports } from "../reports/ITDataConfig";
import ReportCard from "../components/reportCard";

function useFavourites(key = "itdataFavourites") {
...
const VIEW_STORAGE_KEYS = {
  mode: "itdataViewMode",
  favesOnly: "itdataViewFavesOnly",
};

export default function ITDataReports() {
