...
import { MalcolmArnoldConfig } from "./MalcolmArnoldConfig.js";

const TRUST_GREEN = "#205c40";

function useFavourites(key = "toolkitFavourites_MalcolmArnold") {
...
export default function MalcolmArnoldToolkit() {
  ...
  const [favourites, toggleFavourite] = useFavourites("toolkitFavourites_MalcolmArnold");
  const [clickedStar, setClickedStar] = useState(null);

  const shownFiles = MalcolmArnoldConfig.filter(
    (file) =>
      searchTerm.trim() === "" ||
